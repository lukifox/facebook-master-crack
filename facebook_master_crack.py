...
def banner():
	...
	print("")
	print("%s╔══════════════════════════════════════════════╗"%(Z))
	print("%s║%s  Author   : %sRYAN                             %s║"%(Z,B,M,Z))
	print("%s║%s  Github   : https://github.com/lukifox       %s║"%(Z,B,Z))
	print("%s║%s  Telegram : https://t.me/LulZ_07             %s║"%(Z,B,Z))
	print("%s║%s  Version  : %s3.0                              %s║"%(Z,B,H,Z))
	print("%s╚══════════════════════════════════════════════╝"%(Z))
	print("")
	xox('            %s》%s》%s》%sRYAN Tool%s《%s《%s《'%(M,H,B,H,B,H,M))
	print("")
...
def random_number():
	...
	print(f" {M}FOR EXAMPLE : {Z}[{H}+95975803XXXXX{Z}]\n")
